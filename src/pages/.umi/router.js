...
import RendererWrapper0 from '/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/.umi/LocaleWrapper.jsx';
...
const routes = [
  {
    ...
    component: __IS_BROWSER
      ? _dvaDynamic({
          ...
          LoadingComponent: require('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/components/PageLoading/index')
            .default,
        })
    ...
    routes: [
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              ...
              models: () => [
                import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/User/models/register.js').then(
                  m => {
      ...
      },
      {
        component: () =>
          React.createElement(
            require('/Users/sixinli/Desktop/SideProjects/HouseSearch/node_modules/umi-build-dev/lib/plugins/404/NotFound.js')
              .default,
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Dashboard/models/activities.js').then(
                      m => {
                        return { namespace: 'activities', ...m.default };
                      },
                    ),
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Dashboard/models/chart.js').then(
                      m => {
                        return { namespace: 'chart', ...m.default };
                      },
                    ),
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Dashboard/models/monitor.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Forms/models/form.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/List/models/rule.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Profile/models/profile.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Exception/models/error.js').then(
                      m => {
          ...
          },
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/sixinli/Desktop/SideProjects/HouseSearch/src/pages/Account/Settings/models/geographic.js').then(
                      m => {
